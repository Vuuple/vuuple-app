...
set -e
  ...
  DDIR="qdata/c8"
    ...
    rm -f "$DDIR/tm.ipc"
    CMD="constellation-node --url=https://127.0.0.1:9008/ --port=9008 --workdir=$DDIR --socket=tm.ipc --publickeys=tm.pub --privatekeys=tm.key --othernodes=https://172.27.150.7:21000/"
